...
/**
 *  Cette classe est un client lourd MDB qui envoi
 *  des messages, peut être utile pour des exemples
 * @author user
 */
public class ClientLourdMDB {
    ...
    public ClientLourdMDB() throws JMSException {
